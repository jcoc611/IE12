...
vlog src/constants.v src/char_decoder.v src/vga_adapter/vga_controller.v src/vga_adapter/vga_address_translator.v src/vga_adapter/vga_pll.v src/vga_adapter/vga_adapter.v src/parsing/char_to_int.v src/parsing/integer.v src/parsing/attribute.v src/parsing/element.v src/parsing/html.v src/reading/dummy.v src/reading/dummy2.v src/rendering/counter.v src/rendering/square.v src/rendering/render_rect.v src/rendering/character.v src/main_test.v
